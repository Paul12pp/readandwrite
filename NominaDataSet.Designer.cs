...
namespace LeeryEscribir {
    ...
    public partial class NominaDataSet : global::System.Data.DataSet {
        ...
        public partial class EmpleadosDataTable : global::System.Data.TypedTableBase<EmpleadosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmpleadosRow AddEmpleadosRow(string Cedula, string Nombre, decimal Sueldo, string Moneda) {
        ...
        public partial class EmpleadosRow : global::System.Data.DataRow {
            ...
            public string Moneda {
                get {
                    return ((string)(this[this.tableEmpleados.MonedaColumn]));
                }
                set {
                    this[this.tableEmpleados.MonedaColumn] = value;
                }
            }
...
namespace LeeryEscribir.NominaDataSetTableAdapters {
    ...
    public partial class EmpleadosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Empleados] WHERE (([Id] = @Original_Id) AND ([Cedula] = @Origi" +
                "nal_Cedula) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Origi" +
                "nal_Nombre)) AND ([Sueldo] = @Original_Sueldo) AND ([Moneda] = @Original_Moneda)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Empleados] ([Cedula], [Nombre], [Sueldo], [Moneda]) VALUES (@C" +
                "edula, @Nombre, @Sueldo, @Moneda);\r\nSELECT Id, Cedula, Nombre, Sueldo, Moneda FR" +
                "OM Empleados WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Empleados] SET [Cedula] = @Cedula, [Nombre] = @Nombre, [Sueldo] = @Sueldo, [Moneda] = @Moneda WHERE (([Id] = @Original_Id) AND ([Cedula] = @Original_Cedula) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ([Sueldo] = @Original_Sueldo) AND ([Moneda] = @Original_Moneda));
SELECT Id, Cedula, Nombre, Sueldo, Moneda FROM Empleados WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LeeryEscribir.Properties.Settings.Default.NominaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Cedula, Nombre, Sueldo, Moneda FROM dbo.Empleados";
        ...
        public virtual int Delete(int Original_Id, string Original_Cedula, string Original_Nombre, decimal Original_Sueldo, string Original_Moneda) {
            ...
            if ((Original_Moneda == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_Moneda));
            }
        ...
        public virtual int Insert(string Cedula, string Nombre, decimal Sueldo, string Moneda) {
            if ((Cedula == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((decimal)(Sueldo));
            if ((Moneda == null)) {
        ...
        public virtual int Update(string Cedula, string Nombre, decimal Sueldo, string Moneda, int Original_Id, string Original_Cedula, string Original_Nombre, decimal Original_Sueldo, string Original_Moneda, int Id) {
            if ((Cedula == null)) {
                throw new global::System.ArgumentNullException("Cedula");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((decimal)(Sueldo));
            if ((Moneda == null)) {
                throw new global::System.ArgumentNullException("Moneda");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((decimal)(Original_Sueldo));
            if ((Original_Moneda == null)) {
                throw new global::System.ArgumentNullException("Original_Moneda");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_Moneda));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Cedula, string Nombre, decimal Sueldo, string Moneda, int Original_Id, string Original_Cedula, string Original_Nombre, decimal Original_Sueldo, string Original_Moneda) {
            return this.Update(Cedula, Nombre, Sueldo, Moneda, Original_Id, Original_Cedula, Original_Nombre, Original_Sueldo, Original_Moneda, Original_Id);
        }
    }
